...
class CustomImageDataset(Dataset):
    def __init__(self, img_files_address, pose_files_address, eye_coor_files_add, crop_coor_files_add, coor_3d_files_add, transform=None):
    ...
    def __getitem__(self, idx):
        ...
        return im_three_channels,pose,eye_coor,crop_coor,coor_3d
