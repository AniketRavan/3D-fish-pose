...
mkdir(['../validation_data_3D_pose_shifted/annotations_',date,'_pose_coor')
...
for path_idx = 1
    ...
    for z = 1:(length(coor_mf_mats)) - 2
		...
		crop_b(1) = crop_b(1) - buffer_y;
                ...
                save(['../validation_data_3D_pose_shifted/crop_coor/annotations_',date,'_crop_coor_',num2str(idx),'.mat'],'crop_coor');  
                save(['../validation_data_3D_pose_shifted/pose_coor/annotations_',date,'_pose_',num2str(idx),'.mat'],'pose');
		idx = idx + 1;               
            end
        end
    end
