...
%                     im_tail = im_tail*(255/double(max(gray_b(:))));
                    imwrite(im,['../training_data_3D_pose_new/images/im_',num2str(idx),'.png'])                  
%                     imwrite(im_tail,['training_side_tail\im_',num2str(idx),'_',num2str(n),'.png'])
		    ...
		    save(['../training_data_3D_pose_new/annotations_',date,'_coor_3d/coor_3d_',num2str(idx),'.mat'],  'coor_3d');
                    save(['../training_data_3D_pose_new/annotations_',date,'_pose/pose_ann_',num2str(idx),'.mat'],  'pose');
                    save(['../training_data_3D_pose_new/annotations_',date,'_crop_coor/crop_coor_ann_',num2str(idx),'.mat'],  'crop_coor');
		    save(['../training_data_3D_pose_new/annotations_',date,'_eye_coor/eye_coor_ann_',num2str(idx),'.mat'],  'eye_coor');
                    idx = idx + 1;
		    if (idx == 500000)
