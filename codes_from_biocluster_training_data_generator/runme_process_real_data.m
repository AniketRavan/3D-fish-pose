...
for path_idx = 1
    ...
    for z = 1:length(coor_mf_mats) - 2 % 191
...
%                 gray_s2 = gray_s2(:,:,1);
                ...
                imwrite(im,[data_dir,'/images_real/im_',num2str(z),'_',num2str(idx),'.png'])
		imwrite(im_gray, [data_dir,'/images_gray/im_',num2str(z),'_',num2str(idx),'.png'])
                save([data_dir,'/annotations_',date,'_crop_coor/crop_coor_ann_',num2str(z),'_',num2str(idx),'.mat'],'crop_coor');  
                save([data_dir,'/annotations_',date,'_coor_3d/coor_3d_ann_',num2str(z),'_',num2str(idx),'.mat'],'coor_3d');
		idx = idx + 1;               
            end
        end
    end
