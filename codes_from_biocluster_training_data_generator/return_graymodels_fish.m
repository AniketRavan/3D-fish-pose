...
crop_b(1) = round(coor_b(2,3)) - (imageSizeY - 1)/2 + round((rand - 0.5)*40);
crop_b(2) = crop_b(1) + imageSizeY - 1;
crop_b(3) = round(coor_b(1,3)) - (imageSizeX - 1)/2 + round((rand - 0.5)*40);
crop_b(4) = crop_b(3) + imageSizeX - 1;

crop_s1(1) = round(coor_s1(2,3)) - (imageSizeY - 1)/2 + round((rand - 0.5)*40);
crop_s1(2) = crop_s1(1) + imageSizeY - 1;
crop_s1(3) = round(coor_s1(1,3)) - (imageSizeX - 1)/2 + round((rand - 0.5)*40);
crop_s1(4) = crop_s1(3) + imageSizeX - 1;

crop_s2(1) = round(coor_s2(2,3)) - (imageSizeY - 1)/2 + round((rand - 0.5)*40);
crop_s2(2) = crop_s2(1) + imageSizeY - 1;
crop_s2(3) = round(coor_s2(1,3)) - (imageSizeX - 1)/2 + round((rand - 0.5)*40);
