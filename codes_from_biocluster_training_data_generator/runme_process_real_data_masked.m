...
mkdir('../validation_data_3D_pose_masked/crop_coor')
mkdir('../validation_data_3D_pose_masked/images')
for path_idx = 1
...
%                 saveas(gcf, ['histograms_noise_characterization/hist_',num2str(idx),'.png'])
                ...
                imwrite(im,['../validation_data_3D_pose_masked/images/im_',num2str(idx),'.png'])
                save(['../validation_data_3D_pose_masked/crop_coor/crop_coor_',num2str(idx),'.mat'],'crop_coor');  
                idx = idx + 1;               
            end
        end
    end
