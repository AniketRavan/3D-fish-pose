...
% path{3} = '../results_ob';
idx = 0;
data_dir = '../training_data_3D_pose_channels/';
swimtype = 'er';
...
%     Crop_b, Crop_s1, Crop_s2);
                    ...
                    gray_b = imnoise(gray_b, 'gaussian', (rand*normrnd(70,10))/255,  (rand*60+20)/255^2); %mean in range(7,10), var in range(40,50)
                    gray_s1 = imnoise(gray_s1, 'gaussian', (rand*normrnd(30,10))/255,  (rand*60+10)/255^2); %mean in range(4,5), var in range(10,12)
                    gray_s2 = imnoise(gray_s2, 'gaussian', (rand*normrnd(30,10))/255,  (rand*60+10)/255^2);
                    ...
                    pose = [c_b, c_s1, c_s2];
                    im_channels = returned_annotation_channels(gray_b, c_b, c_s1, c_s2, eye_b, eye_s1, eye_s2);
                    save([data_dir,'images_channels/im_',num2str(idx),'.mat'], 'im_channels')
