...
reshaped_s1(max(1,s1_y):min(size(im_s1,1), crop_s1_0(2) - crop_s1_new(1) + 1),...
    max(s1_x,1):min(size(im_s1,2), crop_s1_0(4) - crop_s1_new(3) + 1)) = ...
    im_s1(max(crop_s1_new(1) - crop_s1_0(1) + 1, 1):min(crop_s1_new(2) - crop_s1_0(1) + 1, size(im_s1,1)),...
    max(crop_s1_new(3) - crop_s1_0(3) + 1, 1):min(crop_s1_new(4) - crop_s1_0(3) + 1, size(im_s1,2)));

reshaped_s2(max(1,s2_y):min(size(im_s2,1), crop_s2_0(2) - crop_s2_new(1) + 1),...
    max(s2_x,1):min(size(im_s2,2), crop_s2_0(4) - crop_s2_new(3) + 1)) = ...
    im_s2(max(crop_s2_new(1) - crop_s2_0(1) + 1, 1):min(crop_s2_new(2) - crop_s2_0(1) + 1, size(im_s2,1)),...
    max(crop_s2_new(3) - crop_s2_0(3) + 1, 1):min(crop_s2_new(4) - crop_s2_0(3) + 1, size(im_s2,2)));