    ...
    with torch.no_grad():
        ...
        for i, data in enumerate(dataloader):
            for p in range(0,1): 
                ...
                im_three_channels,coor_3d_data,crop_coor_data = data
                ...
                pose_data_b[:,0,:] = pose_data_b[:,0,:] - crop_coor_data[:,0,2,None] + 1
                pose_data_b[:,1,:] = pose_data_b[:,1,:] - crop_coor_data[:,0,0,None] + 1
                pose_data_s1[:,0,:] = pose_data_s1[:,0,:] - crop_coor_data[:,0,6,None] + 1
                pose_data_s1[:,1,:] = pose_data_s1[:,1,:] - crop_coor_data[:,0,4,None] + 1
                pose_data_s2[:,0,:] = pose_data_s2[:,0,:] - crop_coor_data[:,0,10,None] + 1
                pose_data_s2[:,1,:] = pose_data_s2[:,1,:] - crop_coor_data[:,0,8,None] + 1
