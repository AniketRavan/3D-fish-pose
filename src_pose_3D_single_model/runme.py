...
pose_folder = '../lookup_table_head/training_data_3D_' + date + '/annotations_' + date + '_pose_tensor/'
pose_files = sorted(os.listdir(pose_folder))
pose_files_add = [pose_folder + file_name for file_name in pose_files]

crop_coor_folder = '../lookup_table_head/training_data_3D_' + date + '/annotations_' + date + '_pose_tensor/'
...
eye_coor_folder = '../lookup_table_head/training_data_3D_' + date + '/annotations_' + date + '_eye_coor_tensor/'
...
im_folder = '../lookup_table_head/training_data_3D_'+  date + '/images/'
