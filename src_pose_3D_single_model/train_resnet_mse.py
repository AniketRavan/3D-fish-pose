...
pose_folder = '../lookup_table_head/training_data_3D_pose_new/annotations_220615_pose_tensor/'
pose_files = sorted(os.listdir(pose_folder))
pose_files_add = [pose_folder + file_name for file_name in pose_files]

crop_coor_folder = '../lookup_table_head/training_data_3D_pose_new/annotations_220615_pose_tensor/'
...
eye_coor_folder = '../lookup_table_head/training_data_3D_pose_new/annotations_220615_eye_coor_tensor/'
...
im_folder = '../lookup_table_head/training_data_3D_pose_new/images/'
...
torch.save(model.state_dict(), 'resnet_pose_220626.pt')
